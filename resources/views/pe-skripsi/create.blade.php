                    ...
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900 dark:text-gray-200">
                                {{ __('Create') }} Pengajuan Skripsi</h1>
                        ...
                        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                            <a type="button" href="{{ route('pe-skripsis.index') }}"
                                class="block rounded-md bg-indigo-600 dark:bg-indigo-500 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Back</a>
                        </div>
                    </div>
                    <div class="flow-root">
                        <div class="max-w-xl py-2 align-middle ml-5">
                            <div class="max-w-xl py-2 align-middle">
                                <!-- Alpine.js Component -->
                                <form x-data="submitHandler" method="POST" action="{{ route('pe-skripsis.store') }}"
                                    ...
                                    <div x-show="show" @click.away="show = false" style="display: none;"
                                        ...
                                        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-sm w-full">
                                            ...
                                            <p class="dark:text-gray-400">Apakah Anda yakin ingin mengirim form ini?
                                            </p>
